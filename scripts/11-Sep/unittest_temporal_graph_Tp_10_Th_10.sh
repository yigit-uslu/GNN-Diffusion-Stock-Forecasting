...
group_name="11-Sep/TimeConv-GNN-Tp=$past_window-Th=$future_window"
...
conv_batch_norm_diffusion=False # Whether batch norm is applied in each GNN layer following the GConv.
