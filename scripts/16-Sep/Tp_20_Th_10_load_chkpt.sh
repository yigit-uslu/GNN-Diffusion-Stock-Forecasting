...
group_name="19-Sep/GUNet-Checkpointloading-Tp-$past_window-Th-$future_window"
...
load_cd_train_chkpt_path_diffusion="Price-Forecast-GDM-Experiments/16-Sep/GUNet-Sweeps-Tp-20-Th-10/1758087371.3831458_seed_42/cd-models/cd_train_chkpt_epoch_199.pt"

# num_graphs=80 # 32
MAX_EFFECTIVE_BATCH_SIZE_DIFFUSION=200
EFFECTIVE_TRAINING_STEPS=200000 #100000
