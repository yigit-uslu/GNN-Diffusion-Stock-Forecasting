...
group_name="16-Sep/UnitTests-GUNet"
...
weight_decay_diffusion=1e-4 # 1e-6
...
dropout_rate_diffusion=0.1 # 0.0
###############################
...
pool_ratio_diffusion=0.5 # 0.8
n_convs_per_block_diffusion=2
pool_layer_diffusion="mean" # <- max
