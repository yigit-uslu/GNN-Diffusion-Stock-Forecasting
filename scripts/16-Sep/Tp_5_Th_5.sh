...
past_window=5 # 25 Past window of features including closing prices and daily log returns
future_window=5 # 10 Set these windows equal =$past_window
# group_name="17-Aug/100-nodes-graph-density-12-rmin-0.6"
group_name="16-Sep/GUNet-Sweeps-Tp-$past_window-Th-$future_window"
...
###############################
hidden_dim_diffusion=64 # 64 <-> 32
###############################
x_batch_size_diffusion=100 # 25 <-> 100
